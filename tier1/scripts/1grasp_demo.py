...
if __name__ == '__main__':
	...
	# open gripper
	move_group_gripper.moveToJointPosition(['l_gripper_finger_joint','l_gripper_finger_joint'],[0.045, 0.045],wait=False)
	...
	move_group_gripper.moveToJointPosition(['l_gripper_finger_joint','l_gripper_finger_joint'],[0.015, 0.015],wait=False)
	move_group_gripper.get_move_action().wait_for_result()
	result = move_group_gripper.get_move_action().get_result()
	...
	gripper_tuckin.pose.position.z = 1.0
